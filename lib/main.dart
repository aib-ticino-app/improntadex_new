...
class _SchermataPrincipaleState extends State<SchermataPrincipale> {
  // ELENCO COMPLETO DELLA FAUNA DELLA LOMBARDIA (Alpi, Prealpi, Pianura e Parco del Ticino)
  final List<AnimalData> tuttiGliAnimali = [
    ...
    AnimalData(
      ...
      dettaglioImpronta: 'Simile a quella di un matto domestico ma più massiccia e senza artigli visibili.',
      ...
      rarita: 'Rarissimo',
      coloreRarita: Colors.purple,
      percorsoFoto: 'assets/images/GattoSelvatico.jpeg',
    ),
    AnimalData(
      nome: 'Nutria',
      ...
      curiosita: 'Presente in grandissima quantità lungo i fiumi, i canali e le risaie della pianura lombarda.',
      rarita: 'Comune',
      coloreRarita: Colors.green,
    ...
    AnimalData(
      ...
      dettaglioImpronta: 'Impronte larghe e piatte, spesso accompagnate dal segno strisciato del corpo o della coda sulla terra smossa.',
      cosaMangia: 'Erbe alpine, fiori, radici e semi.',
      curiosita: 'Vivono in colonie familiari e lanciano un forte fischio acuto per avvisare il branco in caso di pericolo!',
      rarita: 'Comune',
      coloreRarita: Colors.green,
    ...
    AnimalData(
      ...
      dettaglioImpronta: 'Impronte minuscole con dita sottili, raramente visibili a terra perché vive quasi sempre sugli alberi.',
      cosaMangia: 'Faggiuole, ghiande, frutta, castagne.',
      curiosita: 'È un vero campione di sonno: va in letargo a ottobre e si risveglia a maggio (dorme circa 7 mesi l\'anno)!',
      rarita: 'Comune',
      coloreRarita: Colors.green,
    ...
    AnimalData(
      ...
      categoria: 'Anfibi',
      tipoImpronta: 'Piccole zampe a 4 e 5 dita (senza artigli)',
      dettaglioImpronta: 'Tracce leggerissime e fangose, spesso accompagnate dal solco della pancia sul muschio umido.',
      cosaMangia: 'Lombrici, lumache, piccoli insetti.',
      curiosita: 'La sua livrea nera e gialla brillante serve a "avvisare" i predatori della sua tossicità.',
      rarita: 'Comune',
      coloreRarita: Colors.green,
    ...
    AnimalData(
      ...
      dettaglioImpronta: 'Impronte molto larghe rispetto alla lepre comune, perché il pelo fitto funge da "ciaspolata" naturale sulla neve.',
      cosaMangia: 'Germogli, cortecce, rametti di mirtillo.',
      curiosita: 'D\'inverno cambia completamente colore e diventa bianca come la neve per mimetizzarsi sulle Alpi.',
      rarita: 'Non comune',
      coloreRarita: Colors.orange,
    ...
    AnimalData(
      ...
      dettaglioImpronta: 'Tracce minuscole sul fango umido dei boschi di pianura, difficili da individuare.',
      cosaMangia: 'Insetti, mosche, ragni e piccoli invertebrati.',
      curiosita: 'È una tipica "rana rossa" di pianura ed è un endemismo prezioso della Pianura Padana e della Lombardia!',
      rarita: 'Vulnerabile',
      coloreRarita: Colors.orange,
    ...
    AnimalData(
      ...
      dettaglioImpronta: 'Non lascia zampe ma un caratteristico solco ondulato o strisciato sul terreno sabbioso o erboso.',
      cosaMangia: 'Lucertole, micro-mammiferi, rane, altri serpenti.',
      curiosita: 'È un serpente agilissimo, non velenoso e di ottima vista, molto comune nelle campagne e nei parchi lombardi.',
      rarita: 'Comune',
      coloreRarita: Colors.green,
